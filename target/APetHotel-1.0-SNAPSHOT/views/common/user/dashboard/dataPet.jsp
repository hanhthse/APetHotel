        ...
        <c:if test="${sessionScope.nameUserFind == null}">
            ...
            <div class="col-5">
                <nav class="navbar navbar-light pl-sm-0 justify-content-end">
                    <form class="form-inline" action="mainControllers?action=dashboard&action1=searchPetManager" method="post">
                ...
                <div class="card">
                    <div class="card-body d-flex">
                        <div class="w-75">
                            ...
                            <form action="mainControllers?action=dashboard&action1=history" method="POST" id="formHistory${pet.petId}">
