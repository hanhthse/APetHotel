...
public class AdminFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            //lay ve account trong session
            Users user = (Users) session.getAttribute(Constant.SESSION_ACCOUNT);
            //kiem tra acc != null
            if (user == null) {
                resq.sendRedirect(req.getServletContext().getContextPath() + "/mainControllers?action=login");
            } else {
                // kiem tra role
                if (user.getRoleId() != Constant.ROLE_ADMIN) {
                    resq.sendRedirect(req.getServletContext().getContextPath() + "/mainControllers");
                }
            }
