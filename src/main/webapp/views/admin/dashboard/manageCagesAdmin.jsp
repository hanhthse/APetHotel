...
<html>
        ...
        <jsp:include page="../../common/nofication.jsp"></jsp:include>
            ...
            <jsp:include page="../../common/admin/sideBar.jsp"></jsp:include>
                <div id="content-wrapper">
                    <!--Nút add Cage-->
                <jsp:include page="../../common/admin/buttonAddCage.jsp"></jsp:include>
                    <!--List Cage-->
                <jsp:include page="../../common/admin/dataCages.jsp"></jsp:include>
    ...
    <jsp:include page="../../common/user/dashboard/scrollTopButton.jsp"></jsp:include>
        <!--AddPet Modal-->
    <jsp:include page="../../common/admin/addCagesModal.jsp"></jsp:include>
        <!--delete Modal-->
    <jsp:include page="../../common/admin/deleteCagesModal.jsp"></jsp:include>
        <!--Edit cagre Modal-->
    <jsp:include page="../../common/admin/editCagesModal.jsp"></jsp:include>
        <!--HIstory Pet Modal-->
